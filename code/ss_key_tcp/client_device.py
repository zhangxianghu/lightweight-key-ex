...
aliceSockserver1.setsockopt(socket.SOL_SOCKET, socket.SO_REUSEADDR, 1)
...
aliceSockserver2.setsockopt(socket.SOL_SOCKET, socket.SO_REUSEADDR, 1)
...
aliceSockserver3.setsockopt(socket.SOL_SOCKET, socket.SO_REUSEADDR, 1)
...
aliceSockserver4.setsockopt(socket.SOL_SOCKET, socket.SO_REUSEADDR, 1)
...
CPU_key_share_end = count_end() - CPU_key_share_start
...
CPU_open_share_end = count_end() - CPU_open_share_start
...
time_total_CPU = CPU_setting_end + CPU_key_share_end + CPU_open_share_end

total_messages_send = 16 * helpers * num_tk * 2
total_messages_receive = 4 * 5

# print(time_setting_end, time_key_share_end, time_open_share_end)
f = open("eval_sss_1.txt", "a")
